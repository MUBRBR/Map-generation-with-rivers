...
-- simple conversion between f64 and u32.
...
-- using min-max normalization to normalize t to be between 0 and 1 for rgb-linear interpolation.
...
-- tester lige nu kun med futhark executable, som er meget langsomt.
-- kører derfor med et mindre tal som stadig kan udtrykkes som 2^n

-- Findes der en bedre måde at initialisere mine 2D arrays?
-- replicate fungere kun på 1D array
-- kunne ikke umiddelbart finde andet herinde:
-- https://futhark-lang.org/docs/prelude/doc/prelude/array.html
...
-- > :img main 512i64 0.0f64 0.0f64 1.0f64
