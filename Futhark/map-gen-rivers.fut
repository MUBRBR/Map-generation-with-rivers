...
-- simple conversion between f32 and u32.
...
def main (sed : f32) (resolution : i64) (zoomXStart : f32) (zoomYStart : f32) (viewDistance : f32) =
    let seed = sed/100000
...
-- example to print.
-- run it by using 'futhark literate map-gen-rivers.fut --backend-SomeBackend'
-- SomeBackend can be cuda/multicore/opencl/pyopencl - default is c which is sequential.


-- > :img main 0f32 4096i64 0.0f32 0.0f32 1.0f32

-- > :img main 47000f32 4096i64 0.0f32 0.0f32 1.0f32

-- > :img main 100000f32 4096i64 0.0f32 0.0f32 1.0f32

-- > :img main 99000f32 4096i64 0.0f32 0.0f32 1.0f32

-- > :img main 2000f32 4096i64 0.0f32 0.0f32 1.0f32

-- > :img main 1000f32 4096i64 0.0f32 0.0f32 1.0f32
